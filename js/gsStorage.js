...
var gsStorage = {
  ...
  getSettingsDefaults: function() {
    ...
    defaults[gsStorage.IGNORE_PINNED] = false;
    defaults[gsStorage.IGNORE_FORMS] = false;
    defaults[gsStorage.IGNORE_AUDIO] = false;
    defaults[gsStorage.IGNORE_ACTIVE_TABS] = true;
    defaults[gsStorage.IGNORE_CACHE] = false;
    defaults[gsStorage.ADD_CONTEXT] = false;
    defaults[gsStorage.SYNC_SETTINGS] = false;
    defaults[gsStorage.SUSPEND_TIME] = '5';
    defaults[gsStorage.NO_NAG] = false;
    defaults[gsStorage.WHITELIST] = 'https://login.five9.com https://teams.microsoft.com/ https://smiledirectclub.com/ https://outlook.office365.com/ https://outlook.microsoft.com/ https://teams.office365.com/ https://outlook.office.com/ https://teams.office.com/ https://smileco.okta.com/ https://app-scl.five9.com/ https://staff.smileco.cloud/ https://us1.five9.com/ https://smiledirectclub.my.salesforce.com/ https://smiledirectclub--qa.lightning.force.com/ https://smiledirectclub.lightning.force.com/';
